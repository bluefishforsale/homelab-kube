...
{{ include "sops-secrets-operator.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "sops-secrets-operator.selectorLabels" -}}
...
*/}}
{{- define "sops-secrets-operator.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "sops-secrets-operator.fullname" .) .Values.serviceAccount.name }}
{{- else }}
